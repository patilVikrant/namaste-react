    ...
    return restaurantArray.length === 0 ? <Shimmer /> : (
        <div className="body">
            <div className="flex items-center gap-2">
                <input type="text" data-testid="searchInput" className="border border-solid border-black rounded-md p-2 m-4" value={searchText} onChange={(e) => setSearchText(e.target.value)} />
            ...
            <div className="filter">
                <button className="m-4 p-2 border border-solid border-blue-300 rounded-md bg-blue-300 cursor-pointer text-white " onClick={() => {
                    ...
                    setFilteredArray(filteredRestaurantArray);
